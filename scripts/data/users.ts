...
export const users: SeedUser[] = [
  ...
  { uid: 'u-edu',       displayName: 'Edu',       email: 'edu@charcuteria.demo',       password: PWD, role: 'despacho' },
  { uid: 'u-morena',    displayName: 'Morena',    email: 'morena@charcuteria.demo',    password: PWD, role: 'despacho' },
  ...
  { uid: 'u-ciro',      displayName: 'Ciro',      email: 'ciro@charcuteria.demo',      password: PWD, role: 'superAdmin' },
  { uid: 'u-luis',      displayName: 'Luis',      email: 'luis@charcuteria.demo',      password: PWD, role: 'superAdmin' },
];
