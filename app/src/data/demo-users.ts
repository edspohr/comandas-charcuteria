...
export const demoUsers: DemoUser[] = [
  ...
  { uid: 'u-edu',       displayName: 'Edu',       email: 'edu@charcuteria.demo',       role: 'armador' },
  { uid: 'u-morena',    displayName: 'Morena',    email: 'morena@charcuteria.demo',    role: 'armador' },
  ...
  { uid: 'u-ciro',      displayName: 'Ciro',      email: 'ciro@charcuteria.demo',      role: 'admin' },
  { uid: 'u-luis',      displayName: 'Luis',      email: 'luis@charcuteria.demo',      role: 'admin' },
];
